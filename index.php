...
<html lang="en">
  <head>
    ...
    <title>ascension busines concern</title>
    <!-- <link rel="icon" type="image/png" href="image/icon512.png"> -->
    <link href="image/icon512.png" rel="shortcut icon" type="image/x-icon">
  ...
  <body>    
    ...
    <section id="home" class="text-white tm-font-big tm-parallax">
      ...
      <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">              
        <div class="container">   
          <div class="tm-next">
              <a href="#home" class="navbar-brand"><img src="img/abc.png" alt="image" height="52px" width="95px">
              </a>
          </div>             
      ...
      <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title">
              <u>
              <font color="red">A</font><font color="yellow">scension</font> <font color="red">B</font><font color="yellow">usiness</font> <font color="red">C</font><font color="yellow">oncern</font></u>
            </h2>
            <p class="tm-hero-subtitle">
              <font color="yellow">tag line here</font>
              <br> <font color="yellow">thorai mitho line haru</font>
            </p>
        </div>        
      </div>
                ...
                <div class="col-lg-12 col-xl-12">
                    <div class="tm-intro-text-container">
                        ...
                        <p class="mb-4 tm-intro-text">
                          j j kaam garxau tesko bare ma yaha<a href="https://www.facebook.com/GRANITEPAINTNEPAL/">facebook link</a>.</p>
                    </div>
                </div>
            ...
            <div class="row tm-content-box"><!-- second row -->
                ...
                <div class="col-lg-5">
                    <div class="tm-intro-text-container">
                        ...
                        <p class="mb-4 tm-intro-text">
                          yaha market analysis ko bare ma gaff deyeana xa
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="tm-intro-text-container">
                        <h2 class="tm-text-primary mb-4">Fast service & Support</h2>
                        <p class="mb-4 tm-intro-text">
                          yaha cjai support service ko bare ma gaff
                        .</p>
                    </div>
                </div>
            ...
            <div class="row tm-content-box"><!-- third row -->
                ...
                <div class="col-lg-5">
                    <div class="tm-intro-text-container">
                        ...
                        <p class="mb-4 tm-intro-text">
                      You have <strong>no</strong> blaah blah blah blah</p>
                ...
                <div class="col-lg-5">
                    <div class="tm-intro-text-container">
                      <h2 class="tm-text-primary mb-4">our community</h2>
                        <p class="mb-4 tm-intro-text">
                      You can change  data on this box
                       </p>
      ...
      <div class="container tm-testimonials-content">
        <div class="row">
          <div class="col-lg-12 tm-content-box">
            <h2 class="text-white text-center mb-4 tm-section-title">Our Teams</h2>
            ...
            <div class="mx-auto tm-gallery-container tm-gallery-container-2">
              <div class="tm-testimonials-carousel">
                <figure class="tm-testimonial-item">
                  <img src="image/anjalthapa.jpg" alt="Image" class="img-fluid mx-auto">
                  ...
                  <figcaption>anjal thapa (Decorater)</figcaption>
                </figure>
            ...
            <div class="col-12">
                <div class="mx-auto tm-gallery-container">
                    <div class="grid tm-gallery">
                      ...
                      <a href="image/gal3.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="image/gal3.jpg" alt="Image 3" class="img-fluid">
                          <figcaption>
                      ...
                      <a href="image/gal4.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="image/gal4.jpg" alt="Image 4" class="img-fluid">
                          <figcaption>
                            <h2><i>Dream Girl <span>Thoughts</span></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="image/gal5.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="image/gal5.jpg" alt="Image 5" class="img-fluid">
                          <figcaption>
                            <h2><i><span>Workstation</span> Offices</i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="image/gal6.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="image/gal6.jpg" alt="Image 6" class="img-fluid">
                          <figcaption>
                            <h2><i>Just Above <span>The City</span></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="image/gal7.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="image/gal7.jpg" alt="Image 7" class="img-fluid">
                          <figcaption>
                            <h2><i>Another <span>Exercise Time</span></i></h2>
                          </figcaption>
                        </figure>
                      </a>
                      <a href="image/gal8.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="image/gal8.jpg" alt="Image 8" class="img-fluid">
                          <figcaption>
                       ...
                       <a href="image/gal8.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="image/gal8.jpg" alt="Image 9" class="img-fluid">
                          <figcaption>
                            <h2><i>Repeated <span>Image Spot</span></i></h2>
                          </figcaption>
                        </figure>
                       ...
                       <a href="image/gal8.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="image/gal8.jpg" alt="Image 10" class="img-fluid">
                          <figcaption>
                            <h2><i>Repeated <span>Image Spot</span></i></h2>
                          </figcaption>
                        </figure>
                       ...
                       <a href="image/gal8.jpg">
                        <figure class="effect-honey tm-gallery-item">
                          <img src="image/gal8.jpg" alt="Image 11" class="img-fluid">
                          <figcaption>
                            <h2><i>Repeated <span>Image Spot</span></i></h2>
                          </figcaption>
                        </figure>
      ...
      <div class="container tm-container-contact">
        ...
        <div class="row">
            ...
            <div class="text-center col-12">
                ...
                <p class="mb-5">
                  for more enquiry/information please dont hesitate to contact us:
                </p><br>
            </div>
            ...
            <div class="col-sm-12 col-md-6">
                ...
                <div class="contact-item">
                  <a rel="nofollow" href="facebook.com/" class="item-link">
                ...
                <div class="contact-item">
                  <a rel="nofollow" href="mailto:meromail@gmail.com" class="item-link">
                      <i class="far fa-2x fa-envelope mr-4"></i>
                      <span class="mb-0">meromail@gmail.com</span>
                  </a>              
                </div>
                
                <div class="contact-item">
                  <a rel="nofollow" href="https://www.google.com/maps/dir//27.6740578,85.3675125/@27.6740299,85.367239,98m/data=!3m1!1e3!4m5!4m4!1m1!4e1!1m0!3e0" class="item-link">
                      <i class="fas fa-2x fa-map-marker-alt mr-4"></i>
                      <span class="mb-0">Kausaltar , Bhaktapur</span>
                  </a>              
                </div>
                
                <div class="contact-item">
                  <a rel="nofollow" href="tel:9813478299" class="item-link">
                      <i class="fas fa-2x fa-phone-square mr-4"></i>
                      <span class="mb-0"><b>9840716078</b>
                      </span>
                  </a> 
                   <a rel="nofollow" href="tel:9840716078" class="item-link">
                      <i class="fas fa-2x fa-phone-square mr-4"></i>
                      <span class="mb-0"><b>9840716078</b>
                      </span>
                  </a>       
          ...
          <p class="mb-0">
          Copyright &copy; 2020 Ascension Business Concern
          
          . <a rel="nofollow" hre="https://www.tooplate.com" title="HTML templates"><font color="#292727">  Designed by TOOPLATE</font></a></p>
        </footer>
